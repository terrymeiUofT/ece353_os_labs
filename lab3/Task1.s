...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: monCon = zeros  (sizeInBytes=16)
	load	[r14+8],r4
	add	r4,48,r4
	store	r0,[r4]
	store	r0,[r4+4]
...
!   _temp_146 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-52]
!   Move address of _temp_146 [left ] into _temp_147
!     make sure index expr is >= 0
	load	[r14+-84],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_149 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-40]
!   Move address of _temp_149 [right ] into _temp_150
!     make sure index expr is >= 0
	load	[r14+-88],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_189 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-48]
!   Move address of _temp_189 [left ] into _temp_190
!     make sure index expr is >= 0
	load	[r14+-80],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_188 = *_temp_190  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-52]
!   if _temp_188 != 1 then goto _Label_187		(int)
	load	[r14+-52],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_187
...
!   _temp_196 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_196 [right ] into _temp_197
!     make sure index expr is >= 0
	load	[r14+-84],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: _temp_195 = *_temp_197  (sizeInBytes=4)
	load	[r14+-24],r1
	load	[r1],r1
	store	r1,[r14+-32]
!   if _temp_195 != 1 then goto _Label_194		(int)
	load	[r14+-32],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_194
...
!   _temp_228 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_227  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_223:
!   Perform the FOR-LOOP termination test
!   if p > _temp_228 then goto _Label_226		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_235 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_235 [p ] into _temp_236
!     make sure index expr is >= 0
	load	[r14+-44],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
