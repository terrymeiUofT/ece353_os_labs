...
------------------------------- Gaming Parlor ----------------------------------
  ...
  function gamingparlor()
    ...
    Players[1].Init("Player B")
    Players[1].Fork(askFrontDesk, 1)
    Players[2].Init("Player C")
    Players[2].Fork(askFrontDesk, 2)
    Players[3].Init("Player D")
    Players[3].Fork(askFrontDesk, 3)
    Players[4].Init("Player E")
    Players[4].Fork(askFrontDesk, 4)
    Players[5].Init("Player F")
    Players[5].Fork(askFrontDesk, 5)
    Players[6].Init("Player G")
    Players[6].Fork(askFrontDesk, 6)
    Players[7].Init("Player H")
    Players[7].Fork(askFrontDesk, 7)
  endFunction
